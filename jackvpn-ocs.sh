...
read -p "Password baru: " -e -i jackvpnpanel DatabasePass
echo ""
...
read -p " Database Name: " -e -i JACK_PANEL DatabaseName
echo ""
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels EZ Connect Mod by Wangzki"  | tee -a log-install.txt
